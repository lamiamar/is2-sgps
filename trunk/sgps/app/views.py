    ...
    for urp in usrolpro:
        ...
        for per in permi:
            ...
            for pri in privi:
                ...
                if pri.Nombre =='Crear':
                    Crear = True
    return render_to_response('admin/Proyecto/administrarMiembros.html',{'user':user, 'proyecto':Proyecto.objects.get(id=id), 'miembros': miembros,'Modificar':Modificar, 'Eliminar':Eliminar, 'Crear':Crear,})
